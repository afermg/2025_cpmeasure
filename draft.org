...
** Use-cases
*** Classifying astrocytes 3D image data
...
- The usage of manually-encoded workflows hinders reproducibility and may render different datasets incomparable.
  
# Reduced reliance on GUI interfaces
- Reducing our reliance in graphical interfaces brings about better scaling capabilities when dealing with high throughput datasets.
